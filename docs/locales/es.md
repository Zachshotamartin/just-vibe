...
Describe el resultado que necesitas e incluye las restricciones. Se conserva el contexto añadido. La instalación no autentica servicios externos, no concede permisos ni inicia agentes de trabajo. Comprueba las herramientas disponibles en tu agente cuando la tarea necesite un servicio.
