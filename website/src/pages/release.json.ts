...
export const GET = () => new Response(JSON.stringify(releaseManifest(pkg, catalog, profiles, packs), null, 2), { headers: { 'content-type': 'application/json; charset=utf-8', 'access-control-allow-origin': '*' } });
