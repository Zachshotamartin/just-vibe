...
References (current stable docs; open the version matching the installed Django): [transactions](https://docs.djangoproject.com/en/stable/topics/db/transactions/), [testing tools](https://docs.djangoproject.com/en/stable/topics/testing/tools/), [migrations](https://docs.djangoproject.com/en/stable/topics/migrations/), [deployment checklist](https://docs.djangoproject.com/en/stable/howto/deployment/checklist/). Select the documentation version matching the project.
