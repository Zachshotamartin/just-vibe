---
name: build
description: "Implement a feature through appropriate verification. Use for a defined feature spanning existing code; use plan for sequencing only, integrate when the core work connects an external service, design for a new visual direction, and orchestrate for multi-phase or delegated work. Specialist commands supply methods for fragile subproblems."
---
