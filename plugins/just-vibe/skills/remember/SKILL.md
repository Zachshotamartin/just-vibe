...
Use the complete request appended to this invocation, preserving all constraints and references. Default mode: **apply**. Apply; explicit convention, scope, and existing memory destination if any.
...
Persist the requested project convention; global behavioral changes require explicit global scope.
...
- Project-only preference does not alter global files; conflicting rules are surfaced instead of silently duplicated.
