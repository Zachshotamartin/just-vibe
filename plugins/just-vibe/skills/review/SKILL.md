---
name: review
description: "Review a change, selected files, or an entire repository for actionable defects. Use for evidence-backed code review of a diff or current source; github-review handles a remote PR by number or URL with its discussion and checks. Choose a security/domain audit when the requested scope is that specific risk surface."
---
